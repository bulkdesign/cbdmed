...
class WC_Product_Variable extends WC_Product {
	...
	*/
	...
	public function add_to_cart_text() {
		return apply_filters( 'woocommerce_product_add_to_cart_text', $this->is_purchasable() ? __( 'Ver opções disponíveis', 'woocommerce' ) : __( 'Read more', 'woocommerce' ), $this );
	}
	...
	public function add_to_cart_description() {
		...
		return apply_filters( 'woocommerce_product_add_to_cart_description', sprintf( __( 'Ver opções disponíveis for &ldquo;%s&rdquo;', 'woocommerce' ), $this->get_name() ), $this );
	}
