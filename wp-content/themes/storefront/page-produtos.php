...
<?php // while ( $encartes->have_posts() ) : $encartes->the_post(); ?> -->
      ...
      <div class="col s12 padding40">
        ...
        <div class="col s12 padding40">
          <div class="col s12 m3 push-m2">
            ...
            <a href="<?php site_url(); ?>/contato" class="btn green bold margin10">COMPRAR</a>
          </div>
          <div class="col s12 m3 pull-m2 right">
            <img src="<?php bloginfo('template_url'); ?>/images/foto-produto.jpg">
  ...
  <div class="parallax-container">
    <div class="container">
      <div class="row">
        <div class="col s12 center margin140">
    ...
    <div class="row">
      <div class="col s12 padding20">
        <div class="col s12 m10 push-m1">
          ...
          <a href="<?php site_url(); ?>/contato" class="btn green-dark bold">ENTRAR EM CONTATO</a>
        </div>
      </div>
    </div>
  </div>
